...
# https://github.com/ubi-agni/moveit_task_constructor/blob/5197f2f5fe9f0650c91734528e95b25a3f08f184/demo/scripts/pickplace.py#L128-L129
# https://www.youtube.com/watch?v=a8r7O2bs1Mc
# findet task_constructor nicht !
...
connect.properties.configureInitFrom(
    core.Stage.PropertyInitializerSource.PARENT)
task.add(connect)
