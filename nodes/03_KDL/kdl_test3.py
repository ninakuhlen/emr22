...
if __name__ == '__main__':
    ...
    # https://blog.actorsfit.com/a?ID=00550-4a671f83-a3bd-41c7-b089-c0b9e48412db#kdl-python
    robot = URDF.from_xml_file("~/ws_moveit/src/ur5-joint-position-control/urdf/ur5_jnt_pos_ctrl.urdf")
    tree = kdl.tree_from_urdf_model(robot)
